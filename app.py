# blender_bot_app_url="https://15609.gradio.app/"
# app_url="https://26906.gradio.app/"
...
def blender_bot(msg):
    ...
    st.markdown(f'Bot : {english_chat}')
...
import os
b_url = st.text_input('Blender Bot Url', 'https://15609.gradio.app/')
t_url = st.text_input('Nix TTS Url', 'https://26906.gradio.app/')
if st.button('Reboot'):
    st.markdown(f'Say something .....')
    blender_bot_app_url=b_url
    app_url=t_url
    while True:
        try:
            with sr.Microphone() as source:
                ...
                MyText = r.recognize_google(audio,language=db["input_language"])
                MyText = MyText.lower()
                st.markdown(f'YOU : {MyText}')
